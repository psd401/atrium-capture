...
Owns Authorization Code + PKCE primitives, authentication-neutral request/response types, the `AtriumGateway` interface, durable publication orchestration, Markdown generation, retry classification, stable idempotency keys, the documented production v1 gateway, and local mock implementations.
